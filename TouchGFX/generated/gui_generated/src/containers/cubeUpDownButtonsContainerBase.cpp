...
cubeUpDownButtonsContainerBase::cubeUpDownButtonsContainerBase() :
    upPressedCallback(0),
    downPressedCallback(0),
    fadeAnimationEnddedCallback(0),
    flexButtonCallback(this, &cubeUpDownButtonsContainerBase::flexButtonCallbackHandler)
{
    setWidth(156);
    setHeight(430);
...
void cubeUpDownButtonsContainerBase::initialize()
{

}

void cubeUpDownButtonsContainerBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &buttonUp)
    {
        //UpPressed
